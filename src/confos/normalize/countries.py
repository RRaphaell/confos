...
_ISO_ALPHA2_COUNTRY: dict[str, str] = {
    ...
    "CN": "China", "DE": "Germany", "FR": "France", "CA": "Canada", "CH": "Switzerland",
    "JP": "Japan", "KR": "South Korea", "IN": "India", "IL": "Israel", "NL": "Netherlands",
    "SG": "Singapore", "AU": "Australia", "SE": "Sweden", "IT": "Italy", "ES": "Spain",
    "AT": "Austria", "BE": "Belgium", "DK": "Denmark", "FI": "Finland", "NO": "Norway",
    "IE": "Ireland", "PT": "Portugal", "PL": "Poland", "CZ": "Czech Republic",
    "GR": "Greece", "HU": "Hungary", "RO": "Romania", "RU": "Russia", "UA": "Ukraine",
    "TR": "Turkey", "BR": "Brazil", "MX": "Mexico", "AR": "Argentina", "CL": "Chile",
    "CO": "Colombia", "ZA": "South Africa", "EG": "Egypt", "SA": "Saudi Arabia",
    "AE": "United Arab Emirates", "QA": "Qatar", "IR": "Iran", "PK": "Pakistan",
    "BD": "Bangladesh", "ID": "Indonesia", "MY": "Malaysia", "TH": "Thailand",
    "VN": "Vietnam", "PH": "Philippines", "HK": "Hong Kong", "TW": "Taiwan",
    "NZ": "New Zealand", "LU": "Luxembourg", "SK": "Slovakia", "SI": "Slovenia",
    "HR": "Croatia", "RS": "Serbia", "BG": "Bulgaria", "EE": "Estonia", "LV": "Latvia",
    "LT": "Lithuania", "IS": "Iceland", "CY": "Cyprus", "MT": "Malta", "LB": "Lebanon",
    "JO": "Jordan", "KW": "Kuwait", "MA": "Morocco", "TN": "Tunisia", "NG": "Nigeria",
    "KE": "Kenya", "ET": "Ethiopia", "GH": "Ghana", "PE": "Peru", "EC": "Ecuador",
    "UY": "Uruguay", "CR": "Costa Rica", "KZ": "Kazakhstan", "UZ": "Uzbekistan",
    "AM": "Armenia", "GE": "Georgia", "AZ": "Azerbaijan", "LK": "Sri Lanka",
    "NP": "Nepal", "MO": "Macau",
}
